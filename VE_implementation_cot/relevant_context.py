...
def evaluate_manual_predictions(dev_set, predictions, contexts, verifying_qs, args, do_print=False):
...
def test_few_shot_manual_prediction(args):
    ...
    evaluate_manual_predictions(dev_set, predictions, contexts, verifying_qs, args, do_print=True)
