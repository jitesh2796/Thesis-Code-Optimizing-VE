...
def _parse_args():
    ...
    parser.add_argument('--retrieval', default= 'wikipedia')
...
def in_context_manual_prediction(ex, prompt_template, engine, prompt_helper, model, new_rationale):
    prompt, stop_signal = prompt_helper.prompt_for_answering_again(ex, prompt_template, new_rationale)
    ...
    pred["text"]= completion.choices[0].message.content
