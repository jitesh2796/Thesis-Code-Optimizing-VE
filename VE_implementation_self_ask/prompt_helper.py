...
class JointPrompHelper:
    ...
    def post_process_prediction(self, p, change_rationale = True):
        ...
        if change_rationale:
            ...
            result["rationale_indices"] = rationale_indices
        return answer, rationale
...
class JointEandPPromptHelper(JointPrompHelper):
    ...
    def prompt_for_joint_prediction(self, ex, prompt_template):
        stop_signal = "\n\n"

        input_example = "Question: {}\nA:".format(ex["question"])
        prompt = "\n".join([prompt_template] + [input_example])
    ...
    # Updated prompt_for_answering_again method to include prompt_template instead of shots
    def prompt_for_answering_again(self, ex, prompt_template, rationale):
        stop_signal = "\n\n"
